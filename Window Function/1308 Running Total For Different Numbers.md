...
* First, we need to have two partitions. `F` and `M`.
* Second, do cumulative summation. Using `SUM(score_points) OVER(PARTITION BY gender ORDER BY day ASC)`

This is the form how we calculate the cummulative summation. 
